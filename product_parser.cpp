...
{
  string cat = "book";
  Book* boo = new Book(cat, prodName_, price_, qty_, isbn_, author_);
  return boo;
}
...
{
  string cat = "clothing";
  Clothing* clo = new Clothing(cat, prodName_, price_, qty_, size_, brand_);
  return clo;
}
...
{
  string cat = "movie";
  Movie* mov = new Movie(cat, prodName_, price_, qty_, genre_, rating_);
  return mov;
}
