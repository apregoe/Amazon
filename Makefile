...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun May 3 11:12:36 2015
# Project:  hw8.pro
# Template: app
...
SOURCES       = book.cpp \
		...
		trojanshop.cpp \
		user.cpp \
		util.cpp moc_login.cpp \
		moc_main_window.cpp \
		moc_new_user_window.cpp
OBJECTS       = book.o \
		clothing.o \
		db_parser.o \
		login.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hw81.0.0/ && $(COPY_FILE) --parents book.h bst.h clothing.h datastore.h db_parser.h graph.h hash.h hashtable.h heap.h login.h main_window.h movie.h msort.h my_datastore.h new_user_window.h product.h product_parser.h review.h splaytree.h user.h util.h .tmp/hw81.0.0/ && $(COPY_FILE) --parents book.cpp clothing.cpp db_parser.cpp login.cpp main_window.cpp movie.cpp my_datastore.cpp new_user_window.cpp product.cpp product_parser.cpp trojanshop.cpp user.cpp util.cpp .tmp/hw81.0.0/ && (cd `dirname .tmp/hw81.0.0` && $(TAR) hw81.0.0.tar hw81.0.0 && $(COMPRESS) hw81.0.0.tar) && $(MOVE) `dirname .tmp/hw81.0.0`/hw81.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hw81.0.0
...
compiler_moc_header_make_all: moc_login.cpp moc_main_window.cpp moc_new_user_window.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_login.cpp moc_main_window.cpp moc_new_user_window.cpp
moc_login.cpp: my_datastore.h \
		datastore.h \
		product.h \
		user.h \
		util.h \
...
moc_new_user_window.cpp: main_window.h \
		msort.h \
		review.h \
		product.h \
		db_parser.h \
		...
		graph.h \
		new_user_window.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) new_user_window.h -o moc_new_user_window.cpp
...
my_datastore.o: my_datastore.cpp my_datastore.h \
		datastore.h \
		product.h \
		user.h \
		util.h \
		...
		graph.h \
		heap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o my_datastore.o my_datastore.cpp

new_user_window.o: new_user_window.cpp new_user_window.h \
		main_window.h \
		msort.h \
		review.h \
		product.h \
		...
		hashtable.h \
		graph.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o new_user_window.o new_user_window.cpp
...
trojanshop.o: trojanshop.cpp login.h \
		my_datastore.h \
		datastore.h \
		product.h \
		user.h \
		...
		db_parser.h \
		product_parser.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o trojanshop.o trojanshop.cpp
...
moc_new_user_window.o: moc_new_user_window.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_new_user_window.o moc_new_user_window.cpp
